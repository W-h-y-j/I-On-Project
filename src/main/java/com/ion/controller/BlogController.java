...
public class BlogController {
	...
	public String BlogCenterNotice(Model model, HttpServletRequest request, @ModelAttribute BlogVO blog)
			throws Exception {
		...
		model.addAttribute("centerid", blog.getNotice_writer());
	...
	public ModelAndView BlogNoticeView(Model model, int notice_no, int page, HttpServletRequest request, BlogVO blog)
	  ...
	  public ModelAndView BlogNoticeEdit(@RequestParam("notice_no") int
			  notice_no,@RequestParam("page") int page, HttpServletRequest request, BlogVO
			  blog) throws Exception {
	  
		  blog = this.blogService.view_notice_cont(notice_no);
	  
		  ModelAndView mav = new ModelAndView(); // "myPage/Notice-Mod"
		  mav.addObject("blog", blog); mav.addObject("page",page);
	...
	public String BlogCenterNoticeCreate(@ModelAttribute BlogVO blog, RedirectAttributes r, HttpServletRequest request)
			throws Exception {
	...
	/*
	 * @RequestMapping(value = "/blog/Calendar",method = RequestMethod.POST) public
	 * Map<Object,Object> addSchedule(@RequestBody BlogVO blog) throws Exception {
	 * Map<Object,Object>map = new HashMap<Object,Object>(); return map; }
	 */
