			...
			<div id="search">
				<p class="searchArea">
					<select class="option">
						...
						type="button" value="검색" class="btn" onclick="check()" />
				</p>
			</div>
			<br />
			<br />
					...
					<tbody>
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/24052');" class="home">힘찬키움지역아동센터</a></td>
						...
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/himchan2009');" class="home">힘찬지역아동센터</a>
							</td>
						...
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/happyhs61');" class="home">흰돌행복한홈스쿨</a></td>
						...
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/grow');" class="home">희망플러스사회적협동조합</a></td>
						...
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/26814');" class="home">희망터지역아동센터</a></td>
						...
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/25175');" class="home">희망터지역아동센터</a></td>
						...
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/hopefull');" class="home">희망찬지역아동센터</a></td>
						...
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/24754');" class="home">희망지역아동센터</a></td>
						...
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/ady353');" class="home">희망지역아동센터</a></td>
						...
						<tr>
							<td class="center"><a href="#"
								onclick="openMinihp('/24299');" class="home">희망지역아동센터</a></td>
