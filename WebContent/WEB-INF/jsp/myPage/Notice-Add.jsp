				...
				<div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
					<div class="bg-white tm-block">
						<div class="row">
							...
							<div class="ml-auto col-xl-8 col-lg-8 col-md-8 col-sm-7 pl-0 text-right">
								<button type="submit" class="btn btn-small btn-primary">등록</button>
							</div>
							
							<!-- 참고용 <div class="col-md-4 col-sm-24 text-right">
							...
							<div class="col-xl-7 col-lg-7 col-md-12">
								<form action="" class="tm-edit-product-form">
									...
									<div class="input-group mb-3">
										<div class="custom-file mt-3 mb-3">
											<label for="name"
												class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-form-label">첨부사항
											</label> <input type="button" class="btn btn-small btn-primary d-block "
												value="파일 첨부"
												onclick="document.getElementById('fileInput').click();" />
										</div>
									</div>
