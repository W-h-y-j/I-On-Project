				...
				<div class="bg-white tm-block h-100">
					<div class="row">
						...
						<div class="col-md-4 col-sm-24 text-right">
							<a href="/Notice-Add" class="btn btn-small btn-primary">등록</a> <a
								href="/Notice-Mod" class="btn btn-small btn-primary">수정</a> <a
								href="/Notice-Del" class="btn btn-small btn-primary">삭제</a>
						</div>
					</div>
						...
						<table
							...
							<tbody>
								<tr class>
									...
									<td onclick="/Notice-View" class="tm-product-name">In
										malesuada placerat (hover)</td>
								...
								<tr>
									<th scope="row"><input type="checkbox"
										aria-label="Checkbox"></th>
									<td class="tm-product-name">Vivamus convallis tincidunt
										nisi</td>
									<td class="text-center">시스템 관리자</td>
